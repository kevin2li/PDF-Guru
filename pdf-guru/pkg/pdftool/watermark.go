...
func WatermarkPDFByText(inFile string, outFile string, markText string, fontFamily string, fontSize int, fontColor string, angle int, opacity float32, num_lines int, line_spacing float32, word_spacing float32, x_offset float32, y_offset float32, multiple_mode bool, layer string, pages string) error {
...
func WatermarkPDFByImage(inFile string, outFile string, wmPath string, angle int, opacity float32, scale float32, num_lines int, line_spacing float32, word_spacing float32, x_offset float32, y_offset float32, multiple_mode bool, layer string, pages string) error {
...
func WatermarkPDFByPDF(inFile string, outFile string, wmPath string, layer string, pages string) error {
...
func RemoveWatermarkByType(inFile string, outFile string, pages string) error {
...
func RemoveWatermarkByIndex(inFile string, outFile string, wmIndex []int, pages string) error {
...
func DetectWatermarkByIndex(inFile string, outFile string, wmIndex int) error {
...
func MaskPDFByRect(inFile string, outFile string, rect []float32, unit string, color string, opacity float32, angle float32, pages string) error {
...
func MaskPDFByAnnot(inFile string, outFile string, annot_page int, color string, opacity float32, angle float32, pages string) error {
