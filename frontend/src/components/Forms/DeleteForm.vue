    ...
    <div>
        <a-form ref="formRef" style="border: 1px solid #dddddd; padding: 10px 0;border-radius: 10px;margin-right: 5vw;"
            ...
            <a-form-item name="page" hasFeedback :validateStatus="validateStatus.page" label="页码范围">
                <a-input v-model:value="store.page" placeholder="待删除的页码范围(留空表示全部), e.g. 1-10" />
            </a-form-item>
...
import { useDeleteState } from '../../store/delete';
...
export default defineComponent({
    ...
    setup() {
        ...
        async function submit() {
            ...
            await handleOps(DeletePDF, [store.input, store.output, store.page]);
